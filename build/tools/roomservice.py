...
DEBUG = False
default_manifest = ".repo/manifests/moon_default.xml"
custom_local_manifest = ".repo/local_manifests/moon_manifest.xml"
custom_default_revision = "8.1"
custom_dependencies = "moon.dependencies"
org_manifest = "MoonOS-Devices"  # leave empty if org is provided in manifest
org_display = "MoonOS-Devices"  # needed for displaying
