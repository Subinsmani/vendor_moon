...
LOCAL_SRC_FILES := common/app/GDialer.apk
...
LOCAL_SRC_FILES := common/app/GContacts.apk
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_TAGS := optional
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_PRIVILEGED_MODULE := true
...
include $(CLEAR_VARS)
LOCAL_MODULE := GMsg
LOCAL_SRC_FILES := common/app/GMsg.apk
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_TAGS := optional
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_PRIVILEGED_MODULE := true
...
include $(CLEAR_VARS)
LOCAL_MODULE := GClock
LOCAL_SRC_FILES := common/app/GClock.apk
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_TAGS := optional
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_PRIVILEGED_MODULE := true
